...
export function LoginView({ onLogin }: LoginViewProps) {
    ...
    return (
        <div className="min-h-screen flex bg-white">
            {/* Left Panel: Form */}
            <div className="w-full md:w-1/2 flex flex-col justify-center px-16 lg:px-32">
                <div className="mb-10">
                    ...
                    <h1 className="text-4xl font-bold text-gray-900 mb-3 tracking-tight">Bienvenido de nuevo</h1>
                    <p className="text-gray-500 text-lg">Ingresa para visualizar la causalidad en tu portafolio.</p>
                </div>
