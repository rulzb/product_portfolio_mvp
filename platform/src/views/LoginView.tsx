...
const LoginView: React.FC = () => {
    ...
    return (
        <section className="flex flex-col md:flex-row min-h-screen w-full bg-white">
            {/* Left Panel: Form */}
            <div className="w-full md:w-1/2 bg-white flex flex-col justify-center px-12 lg:px-24 py-12">
                <div className="mb-8">
                    <div className="flex items-center gap-2 mb-6">
                        <div className="w-8 h-8 bg-black rounded-lg flex items-center justify-center text-white">
                            <Activity className="w-5 h-5" />
                        </div>
                        <span className="font-bold text-xl tracking-tight">ProductAI</span>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <Button variant="github" className="w-full" onClick={() => navigate('/setup')}>
            ...
            <div className="hidden md:flex w-1/2 bg-gray-50 items-center justify-center relative overflow-hidden">
                ...
                <div className="relative bg-white p-6 rounded-2xl shadow-xl border border-gray-100 max-w-sm w-full transform rotate-3 hover:rotate-0 transition-transform duration-500">
